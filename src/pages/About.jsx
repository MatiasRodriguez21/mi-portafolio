    ...
    <div className="container my-5 text-center">
      ...
      <div className="card my-4">
        ...
        <div className="card-body">
          <h2 className="card-title">Soy Matías Rodríguez</h2>
          ...
          <p className="card-text">
            Actualmente, estoy buscando oportunidades como Desarrollador Web Junior para aplicar mis habilidades en un entorno dinámico.
          </p>
          <p className="card-text">
          ...
          <a href="/Rodriguez-Matias.pdf" download className="btn btn-primary mt-3">Descargar mi CV</a>
        </div>
      </div>
    </div>
  );
